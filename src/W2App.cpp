...
void W2App::install() {
	...
	DWORD addrReferencesDDMain =  _ScanPattern("ReferencesDDMain", "\x80\x3D\x00\x00\x00\x00\x00\x75\x15\x56\x8B\x35\x00\x00\x00\x00\x6A\x01\xFF\xD6\x80\x3D\x00\x00\x00\x00\x00\x74\xF3\x5E\x8B\x44\x24\x04\x50\x68\x00\x00\x00\x00\xE8\x00\x00\x00\x00\xC2\x04\x00", "???????xxxxx????xxxxxx?????xxxxxxxxx????x????xxx");
	addrDDMain = *(DWORD*)(addrReferencesDDMain + 0x24) + 0x40;
